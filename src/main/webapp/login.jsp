    ...
    <div class="row justify-content-center">
         <div class="card col-lg-5  col-md-6 col-11 m-auto shadow rounded py-4">
            <div class="w-100 my-3 mb-5">
                ...
                <p class="text-center" style="color: orangered">login with your details to continue</p>
            </div>
            <form  action="login"  method="post">
                ...
                <div class="row mb-0">
                    <div class="text-center">
                        ...
                        <button type="submit" style="width: 45%;" class="my-2 mb-4 text-center rounded py-1  m-auto btn btn-light">
