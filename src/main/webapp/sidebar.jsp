    ...
    <div class="bg-white" id="sidebar-wrapper">
        ...
        <form class="list-group list-group-flush">
            ...
            <button class="list-group-item list-group-item-action text-success fw-bold"><i class="uil uil-building me-2 fs-4 p-2 mycolor3"></i> <a class="mycolor3" style="text-decoration: none;" href="home.jsp?page=departements">Departments</a></button>
