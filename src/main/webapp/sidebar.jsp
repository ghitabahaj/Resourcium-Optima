    ...
    <div class="bg-white" id="sidebar-wrapper">
        ...
        <form class="list-group list-group-flush">
            ...
            <button class="list-group-item list-group-item-action fw-bold "><i class=" uil uil-desktop me-2 fs-4 p-2 mycolor2"></i><a class="mycolor2" style="text-decoration: none; " href="${pageContext.request.contextPath}/equipements">Equipements</a></button>
            <button class="list-group-item list-group-item-action fw-bold text-primary"><i class="uil uil-user-square me-2 fs-4 p-2 mycolor"></i><a class="mycolor" style="text-decoration: none;" href="${pageContext.request.contextPath}/UpdateAccount">Update Account</a></button>
            <button class="list-group-item list-group-item-action fw-bold text-danger"><i class="uil uil-users-alt fs-4 me-2 p-2 mycolor1"></i><a class="mycolor1" style="text-decoration: none;" href="${pageContext.request.contextPath}/users">Employees</a></button>
        </form>
    </div>
